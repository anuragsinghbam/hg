...
import './KnowEvents.css'

export default function KnowEvents() {
  return (
    <section className='as_about_wrapper as_padderTop80 as_padderBottom80'>
      <div className='container'>
        <div className='row'>
            ...
            <div className='as_about_slider'>
              <div>
                <div className='as_aboutimg text-right'>
                  <img
                    src='http://via.placeholder.com/463X505'
                    alt=''
          ...
          <div className='col-lg-6 col-md-6'>
            <h1 className='as_heading'>Know About Events and its Importance</h1>
            <p>
            ...
            <div className='as_contact_expert'>
              ...
              <div>
                ...
                <h1 className='as_orange'><a href='tel: +91 8079687199'>+91 8079687199</a></h1>
              </div>
            </div>
          </div>
        </div>
